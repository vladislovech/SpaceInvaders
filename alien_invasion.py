...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        collisions = pygame.sprite.groupcollide(self.bullets, self.bunkers, True, False)
        for bunker in collisions.values():
            for b in bunker:
                b.health -= 1
                if b.health <= 0:
    ...
    def _update_screen(self):
        ...
        if not self.stats.game_active and self.high_scores.check_new_high_score():
